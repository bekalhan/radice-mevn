				...
				<div class="col-md-7 col-lg-5">
					<div class="wrap">
						...
						<div class="login-wrap">
							<form @submit.prevent="PostDeveloper()" class="signin-form">
		            ...
		            <div class="form-group">
                     ...
                     <div class="form-group">
		              <input id="password" type="password" v-model="secret_key" class="form-control" @blur="v$.secret_key.$touch" >
...
export default
{
	...
	methods :
	{
		PostDeveloper :async function()
		{
			if(!this.v$.$error)
			{
			await this.$store.dispatch("developerregister",{email : this.email,password : this.password,secret_key : this.secret_key});
			 if(this.$store.state.isDeveloperRegister ===true)
            {
          		this.$toast.success('Developer kaydı başarılı');
			...
			{
				this.$toast.error("Lürfen bilgileri kontrol ediniz");
			}     
		},
		RedirectToLogin : function()
		{
			 return this.$router.push('/logdeveloper');
		}
	},
	 validations () {
      return{
